...
try:
    ...
    try:
        ...
        api_dict = {
            ...
            "today_price_api": {"api": "/api/nots/security/daily-trade", "method": "GET"},
            "security_api": {"api": "/api/nots/security", "method": "GET"},
            "graphdata_api": {"api": "/api/nots/market/graphdata", "method": "GET"},
        }
